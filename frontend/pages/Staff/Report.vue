                        ...
                        <v-table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center border">รายงานผู้รับการประเมิน</td>
                                    <td class="text-center border">
                                        <nuxt-link to="/Staff/Re_eva"><v-btn color="warning" prepend-icon="mdi-file" size="small">รายงาน</v-btn></nuxt-link>
                                    </td>
                                </tr>
                            </tbody>
                        </v-table>
